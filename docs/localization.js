const translations = {
  en: {
    ...
    download: "Download on the App Store", downloadKicker: "Download on the", downloadTitle: "App Store", getSupport: "Get support", heroArt: "Lil’ Guy enjoys a cheerful pillow fight, alternating between another Lil’ Guy and a pink Lil’ Girl with pigtails",
  ...
  de: {
    ...
    download: "Im App Store laden", downloadKicker: "Laden im", downloadTitle: "App Store", getSupport: "Support öffnen", heroArt: "Lil’ Guy hat eine fröhliche Kissenschlacht – abwechselnd mit einem weiteren Lil’ Guy und einem pinken Lil’ Girl mit Zöpfen",
